 ...
 */
MYLIB_API Fraction *fraction_init(int numerator, int denominator);
 ...
 */
MYLIB_API void fraction_free(Fraction *frac);
 ...
 */
MYLIB_API void fraction_add(Fraction *frac1, Fraction *frac2);
 ...
 */
MYLIB_API void fraction_subtract(Fraction *frac1, Fraction *frac2);
 ...
 */
MYLIB_API void fraction_multiply(Fraction *frac1, Fraction *frac2);
 ...
 */
MYLIB_API void fraction_divide(Fraction *frac1, Fraction *frac2);
 ...
 */
MYLIB_API void fraction_invert(Fraction *frac);
 ...
 */
MYLIB_API void fraction_negate(Fraction *frac);
 ...
 */
MYLIB_API void fraction_reduce(Fraction *frac);
 ...
 */
MYLIB_API void fraction_check_negatives(Fraction *frac);
